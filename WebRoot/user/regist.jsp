...
<body class="login_bg">
	<div class="login_wrapper">
		<div class="login_box">
			<!-- 左边 -->
			<form action="/user/regist.do" class="loginForm">
				<input type="text" id="strLoginId" placeholder="请输入登录帐号" class="input" onblur="loginIdIsExit()" />
			...
			<div class="login_right">
				<div>已有memory帐号？</div>
				<a href="/user/login.html" class="registor_now">立即登录</a>
			</div>
		</div>
	</div>
</body>
